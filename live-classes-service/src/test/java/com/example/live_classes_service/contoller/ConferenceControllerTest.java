...
class ConferenceControllerTest {
    ...
    void createConference_returns200() throws Exception {
        when(service.createConference(any(), eq(TOKEN))).thenReturn(sampleResponse());
    ...
    void startConference_returns200() throws Exception {
        when(service.startConference(eq("conf-001"), eq(TOKEN))).thenReturn(sampleResponse());
    ...
    void joinConference_returns200() throws Exception {
        ...
        when(service.joinConference(eq("conf-001"), eq(TOKEN))).thenReturn(joinResponse);
    ...
    void startRecording_returns200() throws Exception {
        when(service.startRecording(eq("conf-001"), eq(TOKEN))).thenReturn("Recording Started");
    ...
    void stopRecording_returns200() throws Exception {
        when(service.stopRecording(eq("conf-001"), eq(TOKEN))).thenReturn("Recording Stopped");
    ...
    void endConference_returns200() throws Exception {
        when(service.endConference(eq("conf-001"), eq(TOKEN))).thenReturn("Conference Ended");
